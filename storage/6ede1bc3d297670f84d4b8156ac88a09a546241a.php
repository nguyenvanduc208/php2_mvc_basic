    ...
    <div class="container">
        <div class="flex-w flex-sb-m p-b-52">
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                <a href="<?php echo e(BASE_URL.'client/shop'); ?>" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women">
                    All Products
                </a>
                ...
                <a href="<?php echo e(BASE_URL.'client/cate/'.$item->id); ?>" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 
                    <?php if($idCate == $item->id): ?>
                    how-active1
                    <?php endif; ?>
                " data-filter="*">
...
<?php echo $__env->make('client.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\WEB3013\Assignment\app\views/client/cate.blade.php ENDPATH**/ ?>