        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit-cate?id=<?php echo e($row->id); ?>" type="button" class="btn btn-info">Sửa</a> <br>
                        <a href="delete-cate?id=<?php echo e($row->id); ?>" type="button" class="btn btn-danger">Xóa</a>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\WEB3013\Assignment\app\views/cate/list-category.blade.php ENDPATH**/ ?>